...
int main()
{
 ...
 for(i=0;i<10;i++)
 {
    if( customerNumSearch== arrCustNums[i])
    {
     ...
     if(arrCustBals[i]<500)
     {
       printf("\n\nThe Customer Number: %d No Overdraft Facility Available",arrCustNums[i],arrCustBals[i]);                                   
     } 
     else
     {
       printf("\n\nThe Customer Number: %d Overdraft Facility Available",arrCustNums[i],arrCustBals[i]);                                   
     }                    
